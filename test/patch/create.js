...
describe("patch/create", function () {
  describe("#createPatch", function () {
    ...
    it("should diff large content blocks", function () {
      ...
      const largeTest =
        ".hbh9asgiidc {ehaahc9:ses;bhg9hc:ses;idgaag-hi9aa:cdca;ihgd9gdgca-gdadg:ighchehgaci;ggghdg:edhciag;daagsada:ahhhiaa;ahai7:hgid;}.hbh9asgiidc.hchgihaa {ggghdg:hgid;}.igiidchbh9ah {ihgd9gdgca-hbh9a:gga(" +
      ...
      for (; count > 0; count--) {
        ...
        largeNewValue =
          largeNewValue.substring(0, removePos) +
      ...
      expect(stripSpace(removeChanges.join(""))).to.equal(
        stripSpace(largeTest)
      );
      expect(stripSpace(addChanges.join(""))).to.equal(
        stripSpace(largeNewValue)
      );
    });
