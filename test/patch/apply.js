import { applyPatch, applyPatches } from "../../src/patch/apply.js";
import { parsePatch } from "../../src/patch/parse.js";
import { createPatch } from "../../src/patch/create.js";
  ...
  describe("#applyPatches", function () {
    ...
    it("should handle patches without Index", function (done) {
      ...
      applyPatches(patch, {
        ...
        patched(index, content, callback) {
          expect(content).to.equal(expected[index.newFileName]).to.not.be
            .undefined;
